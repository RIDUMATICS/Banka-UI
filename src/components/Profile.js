    ...
    <div className="content-wrapper">
      <div className="container-fluid">
        <div className="d-flex pt-md-5 px-md-5 row px-3">
          <table className="table table-bordered col-md-8 col-12 order-3 order-md-1 mb-5">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <td colSpan={2} className="text-right">
                  {' '}
                  <Link to="/settings/update-details">
          ...
          <div className="col-md-3 col-12 px-0 text-center order-1 order-md-3">
            <div className="card">
